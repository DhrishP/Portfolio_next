          ...
          >
            <div className="relative z-0 w-full mb-6 group">
              <input
                ...
                name="email"
                id="floating_email"
                className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-muted-foreground peer"
                placeholder=" "
                required
              />
              <label
            ...
            <div className="">
              <textarea
                ...
                className="border-gray-300 border bg-primary-foreground rounded-lg font-mono"
              />
            </div>
            <Button
              className="hover:bg-muted hover:text-primary hover:border-primary border mb-8 md:mb-0"
              type="submit"
              size={"sm"}
            >
              Submit
